...
function People_Introduce() {
  ...
  const speakers = [
    {
      speakerPhoto: "src/assets/speaker/김태용.png", 
      companyPhoto: "src/assets/company/EO.png",
    ...
    {
      speakerPhoto: "src/assets/speaker/김재홍.png", 
      companyPhoto: "src/assets/company/채널코퍼레이션.png",
    ...
    {
      speakerPhoto: "src/assets/speaker/박하민.png", 
      companyPhoto: "src/assets/company/메디쿼터스.webp",
      ...
      {
        speakerPhoto: "src/assets/speaker/이지원.png", 
        companyPhoto: "src/assets/company/플랫퍼.webp",
      ...
      {
        speakerPhoto: "src/assets/speaker/이현희.png", 
        companyPhoto: "src/assets/company/당근서비스.webp",
      ...
      {
        speakerPhoto: "src/assets/speaker/강희진.png", 
        companyPhoto: "src/assets/company/토스.webp",
      ...
      {
        speakerPhoto: "src/assets/speaker/박차진.png", 
        companyPhoto: "src/assets/company/타임트리.webp",
      ...
      {
        speakerPhoto: "src/assets/speaker/후쿠다야스타카.png", 
        companyPhoto: "src/assets/company/후쿠다야스타카_더모델.webp",
